...
(function() {
  jQuery(function() {
    return $('#administrator').dataTable();
  });

  jQuery(function() {
    return $('#administrator').removeClass('display').addClass('table table-striped table-bordered');
  });

  jQuery(function() {
    return $('.dataTables_filter input[type="search"]').attr('class', 'form-control').attr('placeholder', 'Введіть ПІБ, персональний номер або логін співробітника').css({
      'width': '450px',
      'height': '45px',
...
(function() {
  jQuery(function() {
    return $('#claims').dataTable();
  });

  jQuery(function() {
    return $('#claims').removeClass('display').addClass('table table-striped table-bordered');
  });

  jQuery(function() {
    return $('.dataTables_filter input[type="search"]').attr('class', 'form-control').attr('placeholder', 'Введіть інформацію про екіпаж').css({
      'width': '450px',
      'height': '45px',
      'display': 'inline-block',
      'border-radius': '0px'
...
(function() {
  jQuery(function() {
    return $('#crews').dataTable();
  });

  jQuery(function() {
    return $('#crews').removeClass('display').addClass('table table-striped table-bordered');
  });
